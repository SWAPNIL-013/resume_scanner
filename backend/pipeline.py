...
from llm import generate_resume_json,generate_jd_json
...
# import json
# from parser import extract_text_and_links,extract_text_from_jd
# from llm import generate_resume_json,generate_jd_json
...
#     # jd_text=""
#     # if jd_file_path:
#     #     jd_text=extract_text_from_jd(jd_file_path)
#     # print(f"Extracted JD Text:\n{jd_text[:50]}")
...
#         print("JD detected — starting scoring process...")
#         if not weights:
#             weights={k: 1 for k in jd_json.get("fields",{}).keys()}
#         scored_result = generate_score(
#             resume_json,
#             jd_json,
#             weights or {},
...
#     # If JD not provided → only basic parsed resume
#     else:
#         print("No JD provided — skipping scoring.")
#         resume_dict = {
#             **resume_json            
